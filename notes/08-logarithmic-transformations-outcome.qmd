...
Since I am only interested in the results at the model level, I will create a plot of this model's results and interpret regional differences descriptively rather than inferentially. To create this plot I will set urbanization to its mean level (2.00) and then produce a fitted equation for each world region. I will do this with the back-transformed outcome.
