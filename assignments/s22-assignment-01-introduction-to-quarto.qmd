...
For each question, specify the question number (e.g., Question 2) using a level-2 (or smaller) header. Submit both the QMD and knitted HTML file. This assignment is worth 15 points.
