...
3. Recode the `gni_class` variable by creating a dummy variable called `high_gni`. To create this dummy variable use the syntax below. Explain in words (not code) how the `high_gni` dummy variable is being coded. 
